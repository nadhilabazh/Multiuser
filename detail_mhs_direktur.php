...
<body>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #605ca8">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="user_direktur">Lihat Data User</a>
      </li>
        <li class="nav-item">
        ...
        ?>
                            ...
                            <tr>
                                <td>
                                    <a href="hal_direktur.php" class="btn btn-secondary" style="background-color: #486e86">Kembali</a>
                                </td>
                            </tr>
                         <?php } ?>
  </table>
