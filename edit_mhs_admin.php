          ...
          <div class="container"><br><br><br>
                    <div class="col-md-10 text-justify">
                      ...
                      <div class="col-md-11 text-justify">
                        <form action="proses_edit_mhs_admin.php" method="post" enctype="multipart/form-data">
                          <tr>
                           ...
                           <tr>
                            ...
                            <td><button class="btn btn-info" type="submit" name="simpan">Edit Data</button>
                              <a href="hal_admin.php" class="btn btn-secondary" style="background-color:  #864879">Kembali</a></td>
                          </tr>
                        </table>
                        </form>
                      </div>
