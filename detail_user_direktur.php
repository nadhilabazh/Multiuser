...
<body>
   <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #605ca8">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <section class="page-section portfolio" id="input-data" style="background-image:url(bg/bg.jpg)">
         <div class="container"><br><br><br><br><br><br>
            <center><h3> Detail Data User </h3></center> <br><br><br>
        ...
        ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo ':';?></td>
                                <td><?php echo $r_tampil_mhs['password']; ?></td>
                            </tr>                      
                            <tr>
                                ...
                                <td>
                                    <a href="user_direktur.php" class="btn btn-secondary" style="background-color: #486e86">Kembali</a>
                                </td>
                            </tr>
                         <?php } ?>
  </table>
